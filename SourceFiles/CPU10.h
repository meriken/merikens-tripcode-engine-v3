...
static void CPU_DES_SBoxes1_Intrinsics(unsigned char *expansionFunction, vtype *expandedKeySchedule, vtype *dataBlocks, int32_t keyScheduleIndexBase)
{
	vtype var0;
	vtype var1;
	vtype var2;
...
static void CPU_DES_SBoxes2_Intrinsics(unsigned char *expansionFunction, vtype *expandedKeySchedule, vtype *dataBlocks, int32_t keyScheduleIndexBase)
{
	vtype var0;
	vtype var1;
	vtype var2;
...
start:
	CPU_DES_SBoxes1_Intrinsics(context->expansionFunction, context->expandedKeySchedule, context->dataBlocks, keyScheduleIndexBase);

	if (roundsAndSwapped == 0x100)
		goto next;

swap:
	CPU_DES_SBoxes2_Intrinsics(context->expansionFunction, context->expandedKeySchedule, context->dataBlocks, keyScheduleIndexBase);
