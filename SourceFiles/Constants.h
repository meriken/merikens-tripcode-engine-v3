...
#else
#define DEFAULT_OPTION_USE_OPENCL_FOR_CUDA_DEVICES      TRUE
#endif
...
#define DEFAULT_OPTION_SEARCH_DURATION                  0
...
// For screen output
#define PRODUCT_NAME                 "Meriken's Tripcode Engine 3.2.10"
#define COMMAND                      "MerikensTripcodeEngine"
#define STATUS_UPDATE_INTERVAL       10.000       // in seconds
#define NUM_CHECKS_PER_INTERVAL      100
